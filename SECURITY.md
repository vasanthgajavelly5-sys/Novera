...
Vellune is a local Electron application. Reports involving EPUB parsing, unsafe renderer behavior, unrestricted IPC, filesystem access, imported file handling, dependency vulnerabilities, or packaged-app execution are especially important.
