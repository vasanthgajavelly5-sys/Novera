...
The Novera compatibility identifiers retained in the application are project-local historical identifiers for existing data and do not indicate bundled third-party code.
