      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={[styles.wordmark, { color: theme.text }]}>Lirune</Text>
          </View>
